...
#ruledef
{
    ...
    push r_{reg: register}                                                    => 0x37 @ reg`8 ; push value to the stack
    ...
    eq r_{reg_a: register}, r_{reg_b: register}, r_{reg_c: register}        => 0x31 @ reg_a`8 @ reg_b`8 @ reg_c`8 ; if reg_a == reg_b, reg_c = 1 else reg_c = 0
    neq r_{reg_a: register}, r_{reg_b: register}, r_{reg_c: register}       => 0x32 @ reg_a`8 @ reg_b`8 @ reg_c`8 ; if reg_a != reg_b, reg_c = 1 else reg_c = 0
    leq r_{reg_a: register}, r_{reg_b: register}, r_{reg_c: register}       => 0x33 @ reg_a`8 @ reg_b`8 @ reg_c`8 ; if reg_a <= reg_b, reg_c = 1 else reg_c = 0
    geq r_{reg_a: register}, r_{reg_b: register}, r_{reg_c: register}       => 0x34 @ reg_a`8 @ reg_b`8 @ reg_c`8 ; if reg_a >= reg_b, reg_c = 1 else reg_c = 0
    lt r_{reg_a: register}, r_{reg_b: register}, r_{reg_c: register}        => 0x35 @ reg_a`8 @ reg_b`8 @ reg_c`8 ; if reg_a < reg_b, reg_c = 1 else reg_c = 0
    gt r_{reg_a: register}, r_{reg_b: register}, r_{reg_c: register}        => 0x36 @ reg_a`8 @ reg_b`8 @ reg_c`8 ; if reg_a > reg_b, reg_c = 1 else reg_c = 0
}   